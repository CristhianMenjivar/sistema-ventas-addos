...
<html>
    ...
    <%
        ...
        if (tipoForm.equalsIgnoreCase("actualizar")) {
            mar = (Marca) request.getAttribute("marca");
        }
    %>
            ...
            <jsp:include page="../layouts/sliderbar.jsp"></jsp:include>
                ...
                <div class="container">
                    <div class="card card-register mx-auto mt-5">
                        <div class="card-header" style="background-color: #38cc82; color: #fff"><%= tipoForm%> marca</div>
                    <div class="card-body">
                        <form action="marcas" class="form-horizontal" role="form" method="post">

                            <div class="form-group">
                                <%--este input esta oculto para las acciones crear o actualizar--%>
                                <input type="hidden" name="accion" value="<%= tipoForm%>">
                                <% if (tipoForm.equalsIgnoreCase("actualizar")) {%>
                                <input type="hidden" name="idActualizar" value="<%= mar.getIdMarca()%>">
                                <% } %>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" name="idMar" placeholder="Clave..." 
                            ...
                            <div class="text-center">
                                <div class="col-sm-12 col-md-12 col-auto-12">
                                    <a href="marcas" class="btn btn-success"><span class="fas fa-fw fa-angle-double-left"></span> Atras</a>
