...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2019 a las 02:46:17
...
CREATE TABLE `boleta` (
  ...
  `tipoboleta` varchar(25) NOT NULL,
  `estadoboleta` varchar(25) NOT NULL,
...
(1, '122344', 'Manual', 'Cancelado', 20000.00, 'Debito', 1, 'Banco Azteca', '2019-09-27', 30000.00),
...
CREATE TABLE `clientes` (
  ...
  `tipofactura` varchar(25) DEFAULT NULL,
  `estadofactura` varchar(25) DEFAULT NULL,
...
(8, 'cristhian', 'Menjivar', 'laguna seca', '70804980', '98439393', 'Boleta', 'Pendiente', 348937.00, 'Credito', 11, 'Banco Azteca', '2019-09-25', 483847.000, '2182891'),
(9, 'cristhian 9', 'Menjivar', 'laguna seca', '70804980', '98479999', 'Boleta', 'Cancelada', 973239.00, 'Debito', 12, 'Banco Azteca', '2019-09-26', 9747927.000, '94202090');
...
(1, 1, 1, 300, '2019-02-25'),
(2, 28, 10, 870.5, '2019-02-25'),
(3, 37, 31, 1530, '2019-03-03'),
(5, 56, 110, 900.12, '2019-03-30'),
(9, 57, 111, 500, '2019-03-12'),
(10, 2, 113, 500, '2019-03-14'),
(11, 1, 114, 500, '2019-03-13'),
(12, 1, 114, 500, '2019-03-13'),
(13, 1, 114, 500, '2019-03-13'),
(15, 30, 118, 1200, '2019-03-14');
...
INSERT INTO `masvendidos` (`idproductomas`, `cantidad`, `idproducto`, `fecha`) VALUES
(1, 9, 200, '2019-01-14'),
(2, 8, 200, '2019-01-23'),
(3, 9, 500, '2019-02-25'),
(4, 7, 300, '2019-02-25'),
...
CREATE TABLE `notificaciones` (
  ...
  `NombreNoti` varchar(50) NOT NULL,
  `AsuntoNoti` varchar(800) DEFAULT NULL,
...
INSERT INTO `notificaciones` (`idNotificacion`, `idusuario`, `NombreNoti`, `AsuntoNoti`, `fechaNoti`, `visto`) VALUES
(1, 1, 'Realizar un desfile', '                                                                                                                                                                                                                                                                                        se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta se realizo una venta vse realizo una venta se realizo una venta se realizo una venta se realizo una venta\r\n                                    \r\n                                    \r\n                      ', '2019-03-20', 1),
(2, 1, 'venta', '                                                                                                                        se realizo una venta\r\n                                    \r\n                                    \r\n                                    ', '2019-04-01', 1),
(3, 1, 'Hay una reunion', '                                                                                                                        la reunion sera el dia de ahora a las 9am,  la reunion sera el dia de ahora a las 9am  la reunion sera el dia de ahora a las 9am  la reunion sera el dia de ahora a las 9am  la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am la reunion sera el dia de ahora a las 9am\r\n                                    \r\n                                    \r\n                                    ', '2019-10-10', 1),
(7, 1, 'Vender en el parque', '                                                                                                                                                                                                                                                                                                                                                                   Estimados compaÃ?Â±eros Gerentes Generales:\r\nLes informo que para el dia de maÃ?Â±ana 23/3/2019  se debe realizar una campaÃ?Â±a de ventas para lograr las metas de este mes.\r\n                                    \r\n                                    \r\n                                    ', '2019-03-23', 0),
(13, 1, 'Ir a la playa', 'asssssssssssssssssssssssss sssssssssssssssssss saaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaa\r\n                                    \r\n                                    \r\n                                    \r\n                                    \r\n                                    \r\n                                    \r\n                                    ', '2019-03-23', 1),
(10, 1, 'Reun', '                                        \r\n                                    ', '2019-03-23', 0),
(12, 1, 'Machipuchi', '                                        \r\n                                    ', '2019-03-23', 1),
(14, 1, 'reunion', '                                                                                gfcccccccccccccccccccccccccccccccccccc                            \r\n                                    \r\n                                    \r\n                                    \r\n                                    ', '2019-03-23', 1),
(15, 1, 'hola', 'gggggg', '2019-03-23', 1),
(16, 1, 'hay reunion', 'Ã±                              \r\n                                    ', '2019-03-25', 1),
(17, 1, 'diego busca novia', 'asdasdasdasndiasudbuyasbdyuasbdasduyasbduyasuydasyuduyasgdbyuasgbyudgasyudgasdastydastydfyastfdytasfdjytasfdytfasytdfasytdfyastfdytasfd67uasfu67dasfu67dfasu67dgu67asd67uasdytasfdytas                                        \r\n                                    ', '2019-03-26', 1),
(18, 1, 'htfhtthdth', '                                        mhvbhjvjhvjh           \r\n                                    ', '2019-04-01', 0),
(19, 1, 'BEBIDAS', 'asadasdas                               \r\n                                    ', '2019-04-01', 1),
(20, 1, 'asas', 'asasasasasas', '2019-04-13', 1);
...
(200, '7.5', 'zapato', 'blanco y negro', 'serie seria', 'model fashon', 0, 50, 70, 5, 10, 2, 2, 1, 4, NULL),
(150, ' no', 'piza', 'roja', 'no', 'no', 1, 20, 30, 5, 993, 0, 6, 3, 3, NULL),
(300, 'una cuarta', 'Salchichas', 'no', 'no', 'No', 1, 30.5, 40.5, 500, 1090, 0, 9, 4, 2, NULL),
(500, '15 pulgadas', 'computadora ', 'gris', 'xpabillon', 'modelo', 1, 500, 700, 2, 1005, 0, 4, 4, 3, NULL),
(2000, '15 pulgadas', 'TELEVISOR', 'NEGRO', 'NO', 'NO', 1, 300, 500, 800, 1000, 0, 13, 2, 6, NULL),
(100, 'no', 'Celular', 'negro', 'no', 'no', 1, 200, 350, 5, 0, 0, 13, 4, 6, NULL),
(20, '22xs', 'Locion IVON', 'clara', 'no', 'no', 1, 21.5, 35, 25, 76, 0, 4, 7, 6, NULL),
...
ALTER TABLE `categorias`
  ...
  ADD UNIQUE KEY `Nom_categoria_UNIQUE` (`Nom_categoria`);
...
ALTER TABLE `creditos`
  ...
  ADD KEY `fkcredito_venta_idx` (`idventa`),
  ADD KEY `fkcredito_venta_cliente_idx` (`idcliente`);
...
ALTER TABLE `detalle_credito`
  ...
  ADD KEY `fkdetallecredito_credito_idx` (`idcredito`);
...
ALTER TABLE `detalle_ventas`
  ...
  ADD KEY `fkdetalleventa_producto_idx` (`idproducto`),
  ADD KEY `fkdetalle_venta_ventas_idx` (`idventa`);
...
ALTER TABLE `masvendidos`
  ADD PRIMARY KEY (`idproductomas`),
  ADD KEY `fkmasvendidos_producto` (`idproducto`);
...
ALTER TABLE `productos`
  ...
  ADD KEY `fkproductoo_marca` (`idmarca`),
  ADD KEY `fkproductoo_categoria` (`idcategoria`);
...
--
ALTER TABLE `creditos`
  MODIFY `idcredito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `detalle_credito`
  MODIFY `iddetalle_credito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT de la tabla `detalle_ventas`
--
ALTER TABLE `detalle_ventas`
  MODIFY `iddetalle_ventas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=354;
...
--
ALTER TABLE `gastos`
  MODIFY `idgasto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de la tabla `masvendidos`
--
ALTER TABLE `masvendidos`
  MODIFY `idproductomas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `notificaciones`
--
ALTER TABLE `notificaciones`
  MODIFY `idNotificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
